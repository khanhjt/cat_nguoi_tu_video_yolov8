...
cap = cv2.VideoCapture('videothg.mp4')
...
# Dòng liên quan đến vùng (area) đã được chú thích
...
def imgwrite(img):
    ...
    cv2.imwrite(os.path.join(r"D:\yolov8-detect-count-crop-save-main\imgg", filename), img)
...
while True:    
    ...
    for bbox in bbox_idx:
        x3, y3, x4, y4, id = bbox
        # Dòng liên quan đến vùng đã được chú thích
